...
$sql = "SELECT * FROM recipes WHERE category = 'Dessert' ORDER BY created_at DESC";
...
$sql = "SELECT * FROM recipes WHERE category = 'Dessert' ORDER BY created_at DESC LIMIT $limit OFFSET $offset";
$result = $conn->query($sql);

// Count total recipes for pagination
$total_sql = "SELECT COUNT(*) AS total FROM recipes WHERE category = 'Dessert'";
...
<body>
    ...
    <div id="container">
		...
		<div id="add-recipe-button">
            <a href="add_recipe2.php">Add New Recipe</a>
        </div><br><br>
		...
		<?php while ($row = $result->fetch_assoc()) : ?>
			<div class="recipe">
				...
				<h2><a href="recipe_details2.php?recipe_id=<?= $row['recipe_id'] ?>"><?= htmlspecialchars($row['title']) ?></a></h2>
